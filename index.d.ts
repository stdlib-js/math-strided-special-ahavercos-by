...
/**
* Interface describing `ahavercosBy`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the inverse half-value versed cosine of each element retrieved from an input strided array `x` via a callback function and assigns each result to an element in an output strided array `y` using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param x - input array
	* @param strideX - `x` stride length
...
* // y => [ ~3.142, ~1.571, 0.0, ~2.094, ~1.047 ]
*/
declare var ahavercosBy: Routine;
